...
const SellerUpdatePage = () => {
    ...
    const fetchListing = async () => {
      try {
        const res = await fetch(
          `http://localhost:5000/api/v1/laptop-listing/listing/${listingId}`,
          {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      form.append("productName", formData.productName); // custom handling if needed
